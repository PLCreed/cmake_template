...
function(generate_template_export_header target target_id export_file)
    if("${CMAKE_CXX_COMPILER_ID}" MATCHES "MSVC")
        configure_file(${PROJECT_SOURCE_DIR}/src/template_msvc_api.h.in ${CMAKE_CURRENT_BINARY_DIR}/${export_file} @ONLY)
    else()
        configure_file(${PROJECT_SOURCE_DIR}/src/template_api.h.in ${CMAKE_CURRENT_BINARY_DIR}/${export_file} @ONLY)
    endif()
endfunction()
